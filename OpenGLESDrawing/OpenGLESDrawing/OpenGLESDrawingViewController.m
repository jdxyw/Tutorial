//
//  OpenGLESDrawingViewController.m
//  OpenGLESDrawing
//
...
#import "OpenGLESDrawingViewController.h"
#import "EAGLView.h"
#import "monkey.h"
...
@interface OpenGLESDrawingViewController ()
...
@implementation OpenGLESDrawingViewController
...
- (void)drawFrame
{
    ...
    if ([context API] == kEAGLRenderingAPIOpenGLES2) {
        ...
        glVertexAttribPointer(ATTRIB_COLOR, 3, GL_UNSIGNED_BYTE, 1, 0, &MeshVertexData[0].normal);
        ...
        //glTranslatef(0, 0, 1);
        glRotatef(transY, transY, transY, 1);
        transY += 1.75f;
...
//        glEnableClientState(GL_COLOR_ARRAY);
    ...
    //glDrawArrays(GL_TRIANGLE_STRIP, 0, sizeof(MeshVertexData));
