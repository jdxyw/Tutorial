...
- (void)viewDidLoad
{
    NSMutableArray *array=[[NSArray alloc] initWithObjects:@"Lisp",@"Python",@"Perl",@"Java",@"Lisp",@"Python",@"Perl",@"Lisp",@"Python",@"Perl",@"Lisp",@"Python",@"Perl", nil];
    self.list=array;
    [array release];
...
{
    static NSString *CellIdentifier = @"MoveMeCellIdentifier";
