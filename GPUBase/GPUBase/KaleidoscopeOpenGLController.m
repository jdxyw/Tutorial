//
//  KaleidoscopeOpenGLController.m
//  GPUBase
//
...
@implementation KaleidoscopeOpenGLController
...
- (BOOL)loadShaders
{
    ...
    vertShaderPathname = [[NSBundle mainBundle] pathForResource:@"Kaleidoscope" ofType:@"vsh"];
    ...
    fragShaderPathname = [[NSBundle mainBundle] pathForResource:@"Kaleidoscope" ofType:@"fsh"];
